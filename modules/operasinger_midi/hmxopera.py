...
class FastSpeech2MIDI(FastSpeech2):
    ...
    def forward(self, txt_tokens, mel2ph=None, spk_embed=None,
        ...
        ret['diff_mel'] = self.run_decoder(diff_cond, tgt_nonpadding, ret, infer=infer, **kwargs)
        ret['fs2_mel'] = self.run_decoder(decoder_inp, tgt_nonpadding, ret, infer=infer, **kwargs)
