...
# class ConformerLayers(nn.Module):
#     def __init__(self, hidden_size, num_layers, k1=9,k2=9,k3=9,k4=9, dropout=0.1, num_heads=4,
#     #def __init__(self, hidden_size, num_layers, kernel_size=9,dropout=0.1, num_heads=4,
#                  use_last_norm=True, save_hidden=False):
#         super().__init__()
#         self.use_last_norm = use_last_norm
#         self.layers = nn.ModuleList()
...
#             positionwise_layer(*positionwise_layer_args),
#             positionwise_layer(*positionwise_layer_args),
#             #ConvolutionModule(hidden_size, hidden_size,kernel_size, Swish()),
#             multikernelConvolutionModule(hidden_size,k1,k2,k3,k4,Swish()),
#             dropout,
#         ) for _ in range(num_layers)])
#         if self.use_last_norm:
...
#
# class ConformerEncoder(ConformerLayers):
#     def __init__(self, hidden_size, embed_tokens, num_layers=None,num_heads=4):
#         k1=5
#         k2=7
#         k3=9
#         k4=11
...
#
# class ConformerDecoder(ConformerLayers):
#     def __init__(self, hidden_size, num_layers,num_heads=4):
#         k1 = 9
#         k2 = 15
#         k3 = 31
#         k4 = 61
